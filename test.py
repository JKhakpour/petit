...
def text_to_num_tests():
    ...
    assert 1000579851 == text_to_num("یک هزار میلیون و پانصد و هفتاد و نه هزار و هشت صد و پنجاه و  یک ")
    assert 100000579851 == text_to_num("یک صد هزار میلیون و پانصد و هفتاد و نه هزار و هشت صد و پنجاه و  یک ")
    assert 100000579851 == text_to_num(" صد هزار میلیون و پانصد و هفتاد و نه هزار و هشت صد و پنجاه و  یک ")
...
def num_to_ordinal_tests():
    ...
    assert 'یک میلیون و دویست و هشت هزار و نهصد و پنجاه و هشتم' ==  num_to_ordinal(1208958) 
